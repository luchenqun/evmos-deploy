...
const projectDir = path.join(curDir, '..');
let chainId = '9001';
let clientCfg = `
    ...
    if (init || isKeep) {
      ...
      if (!isKeep) {
...

        {
          const initFiles = `${
            platform !== 'win32' ? './' : ''
          }${daemonApp} testnet init-files --validator-count ${nodesCount} --output-dir ./nodes --chain-id ${chainId} --keyring-backend test`;
          const initFilesValidator = `${
            platform !== 'win32' ? './' : ''
          }${daemonApp} testnet init-files --validator-count ${validators} --output-dir ./nodes --chain-id ${chainId} --keyring-backend test`;
          ...
          if (fixedFirstValidator) {
            ...
            await fs.writeFile(
              ...
              'eyJhbGciOiJQQkVTMi1IUzI1NitBMTI4S1ciLCJjcmVhdGVkIjoiMjAyNi0wMS0xMiAxNjo1Mjo1OS41ODE4MzggKzA4MDAgQ1NUIG09KzAuMDg0Nzk5Mzc2IiwiZW5jIjoiQTI1NkdDTSIsInAyYyI6ODE5MiwicDJzIjoiUXo0WDJZRmVrcGN2X1I0WiJ9.PdNUwuUgq3vK-WxyXxwCwD52fIgPFvDqvrKUH1rbMO3rTuTmrMcQ8w.asuUelb6xf1SZJau.dnwvsae0EU6rFc-tba_ySxUWWKqsaVIgTneLCCFtIfbAIESgDkdwF4BxeEcT34bXL9LfURAl3KDgjIyHyKfzR-uE5g4JxqshKvSqEdJHGTt02jN7jTrilXSXRgLJzqvknYeZziQb1hgIeVXigUROacMOx97S_JP64RBlF_d1vivnrssf9QBtiIP8k8cxeV6ShzWuFi6meWBhPJ6kw31Opa7F-KBMijXwU8ov7xUY2n4g9JRf7WA.TfiUl2cW9r9m_KLGcC3LgQ'
            );
            await fs.writeFile(
              path.join(keyringPath, `node0.info`),
              'eyJhbGciOiJQQkVTMi1IUzI1NitBMTI4S1ciLCJjcmVhdGVkIjoiMjAyNi0wMS0xMiAxNjo1Mjo1OS41ODA2MDMgKzA4MDAgQ1NUIG09KzAuMDgzNTY0NTg1IiwiZW5jIjoiQTI1NkdDTSIsInAyYyI6ODE5MiwicDJzIjoiUk92N1l5TTNmOFRWSnNzMCJ9.psZ7om5i21OZqAodW2QXZXVvaaM2edEJ8ed-eKKzgMSIiIiJYede0Q.18FakPihNl8HHo7t.BG6IgH2w96o4Hu5Scc16Qod21Axo_rGHVUm1p_952GAmkMxjSoMIFH9iIsgkFGRmAAZShO_AH5_vCMdOAUcAenl5rwQ2in-S3-4tGuxobM0_WWYKEPim36mIGAuV9oQ-IA8jaZSeZ94ZMu1zILPovSmXr1SoeTUPJQbXy6l7nT9C6CFlIZYWKPkRDLIHz4nqw79zq46KO4-TTtWFFV09zTy2h4mxrSpIniHx1x_o5dK9HIgORbY85m7gHttQYp9bs53K1frsWk8R9Jb2KSa3_4HHeNnqBg1XWRb57sx1x_eMt6G2d1CBcYaI4tvd9vGLmCLon8lCqhG_BY4pAQQJjw2Lk-wARVE8TFsw0IidF17XaXO2Iar4ti5IgcQshEd5zxeNXLr1czN9wTpX0WPiAOovvk8WeogbXeXYprjyrY9MOT2zcrLV0G3XbUx2V7_qjUZnlvEbjxNEmHMSiOwERgi2L-VRGmDn.88B0HIVBVWGj9jlm3nFOsw'
            );
          }
        }
